//
//  FinishedCollectionViewCtrl.swift
//  chatdpua
//
//  Created by Artem on 6/9/17.
...
extension FinishedCollectionViewCtrl: GeneratorDelegate {
...
// ////////////////// FEED ///////////////////////
class FinishedCollectionViewCtrl: UIViewController {
    ...
    fileprivate func getQuestionsFromServerOrCache() {
        ...
        Database.database().reference(fromURL: "https://universequiz-11e9b.firebaseio.com/").removeAllObservers()
    }
...
// ////////////////// DELEG ///////////////////////
extension FinishedCollectionViewCtrl: IGListAdapterDataSource {
...
extension FinishedCollectionViewCtrl: UIViewControllerTransitioningDelegate {
